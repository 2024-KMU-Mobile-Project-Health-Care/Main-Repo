...
public class Eng2Kor {
    ...
    static {
        ...
        engToKorMap.put("Scapula Left", "왼쪽 날개뼈");
        engToKorMap.put("Scapula Right", "오른쪽 날개뼈");
        engToKorMap.put("Shoulder Left", "왼쪽 어깨뼈");
        engToKorMap.put("Shoulder Right", "오른쪽 어깨뼈");
        ...
        engToKorMap.put("Levator scapulae Left", "왼쪽 어깨올림근");
        engToKorMap.put("Levator scapulae Right", "오른쪽 어깨올림근");
